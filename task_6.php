    ...
    <body class="mod-bg-1 mod-nav-link ">
        <main id="js-page-content" role="main" class="page-content">
            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                $cards = [
                    [
                        "avatar-url" => "img/demo/avatars/avatar-b.png",
                        "status" => "status-success",
                        "name-filter" => "oliver kopyov",
                        "name" => "Oliver Kopyov",
                        "position" => "IT Director, Gotbootstrap Inc.",
                        "tel-href" => "+13174562564",
                        "tel" => "+1 317-456-2564",
                    ...
                    [
                        "avatar-url" => "img/demo/avatars/avatar-c.png",
                        "status" => "status-warning",
                        "name-filter" => "sesha gray",
                        "name" => "Sesha Gray",
                        "position" => "Project Manager, Gotbootstrap Inc.",
                        "tel-href" => "+13134611347",
                        "tel" => "+1 313-461-1347",
                    ...
                    [
                        "avatar-url" => "img/demo/avatars/avatar-e.png",
                        "status" => "status-danger",
                        "name-filter" => "dr john cook",
                    ...
                    [
                        "avatar-url" => "img/demo/avatars/avatar-k.png",
                        "status" => "status-success",
                        "name-filter" => "jim ketty",
                        "name" => "Jim Ketty",
                        "position" => "Staff Orgnizer, Gotbootstrap Inc.",
                        "tel-href" => "13137793314",
                        "tel" => "+1 313-779-3314",
                ...
                <?php foreach ($cards as $card):?>
                    <div class="col-xl-4">
                        <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $card['name-filter'];?>">
                            <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                <div class="d-flex flex-row align-items-center">

                                    <span class="status <?php echo $card['status'];?> mr-3">
                                        <span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo $card['avatar-url'];?>'); background-size: cover;"></span>
                                    </span>
                            ...
                            <div class="card-body p-0 collapse show">
                                <div class="p-3">
                                    <a href="tel:<?php echo $card['tel-href'];?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                        <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $card['tel'];?></a>
                                    ...
                                    <address class="fs-sm fw-400 mt-4 text-muted">
                                        <i class="fas fa-map-pin mr-2"></i> <?php echo $card['address'];?></address>
                                    <div class="d-flex flex-row">
                                        <a href="https://<?php echo $card['facebook'];?>" class="mr-2 fs-xxl" style="color:#3b5998">
                                            <i class="fab fa-facebook-square"></i>
                                        </a>
                                        <a href="https://<?php echo $card['twitter'];?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                            <i class="fab fa-twitter-square"></i>
                                        </a>
                                        <a href="https://<?php echo $card['linkedin'];?>" class="mr-2 fs-xxl" style="color:#0077B5">
