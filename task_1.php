                    ...
                    <?php
                        $posts = [
                            [
                                ...
                                We will retain your personal information only for as long as is necessary for the purposes for which the information was collected,
                                 or as long as is required pursuant to law."
                            ],
                            [
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                                <!-- первый вариант: удобнее если цикл в обработке выполняет какието функции -->
                                <?php
                                ...
                                <!-- второй вариант: удобнее работать с html, вывод html, нет кавычек -->
                                <!-- при каждой итерации значение элемента массива, начиная с 0, присваивается переменной $post  -->
